...
public class CadastroProduto extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        ftfPrecoCompra.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#,##0.##"))));
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        if (validarFormulario()) {
            ...
            produto.setValor_compra((Double) ftfPrecoCompra.getValue());
            produto.setValor_venda((Double) ftfPrecoVenda.getValue());
    ...
    private void tbGradeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbGradeMouseClicked
        if (evt.getClickCount() == 2) {
            ...
            ftfPrecoCompra.setValue(produto.getValor_compra());
            ftfPrecoVenda.setValue(produto.getValor_venda());
